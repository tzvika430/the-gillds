...
src = src + "\n" + open("/data/data/com.termux/files/home/SLH-DEV/bot/services/building_service.py", encoding="utf-8").read()
src = src + "\n" + open("/data/data/com.termux/files/home/SLH-DEV/bot/services/economy_service.py", encoding="utf-8").read()
